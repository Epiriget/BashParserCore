...
namespace BashParserCore.Data.Migrations
{
    ...
    [Migration("20170210112953_Email-Invitation")]
    partial class EmailInvitation
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("BashParserCore.Models.InvitationModel", b =>
                {
            ...
            modelBuilder.Entity("BashParserCore.Models.InvitationModel", b =>
                {
                    b.HasOne("BashParserCore.Models.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BashParserCore.Models.ApplicationUser")
                        .WithMany("Claims")
